...
.loop:
    ...
    PSRLDQ XMM3, 4      ; XMM3  <- [ 0       0       |TR-BR| |T2-B2| ]
    ...
    MOVDQA XMM3, XMM1   ; XMM3  <- [ MR P2 P1 ML ]
    PSRLDQ XMM3, 8      ; XMM3  <- [ 0  0  MR P2 ]
    PSUBB XMM3, XMM1    ; XMM3  <- [ X X P1-MR P2-ML ]
    PABSB XMM3, XMM3    ; XMM3  <- [ X X |P1-MR| |P2-ML| ]
    PADDSB XMM15, XMM3  ; XMM15 <- [ X X (|P1-MR|+|TR-T1|)+(|TR-BR|+|T2-B2|+|T1-B1|) (|P2-ML|+|T2-TL|)+(|T2-B2|+|T1-B1|+|TL-BL|) ]
