...
mask_pshufb_1: dq 0x8007800680038002,0x80F0800E800B800A
mask_pshufb_2: dq 0x8005800680018002,0x80D0800E8009800A
mask_pshufb_L: dq 0x0504050401000100,0x0D0C0D0C09080908
mask_pshufb_H: dq 0x0706070603020302,0x0F0E0F0E0B0A0B0A
mask_alpha: dq 0x000000FF000000FF,0x000000FF000000FF
...
; [rbp]    > int umbralSup,
; [rbp+8]  > int umbralInf,
; [rbp+16] > int brilloSup,
; [rbp+24] > int brilloInf)
...
ReforzarBrillo_asm:
	...
	movd xmm0, [rbp]    ; uSup : xmm0[31:0]
	movd xmm1, [rbp+8]  ; uInf : xmm1[31:0]
	movd xmm2, [rbp+16] ; bSup : xmm2[31:0]
	movd xmm3, [rbp+24] ; bInf : xmm3[31:0]
