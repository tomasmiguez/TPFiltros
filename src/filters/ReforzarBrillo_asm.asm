...
mask_pshufb_L: db 0x00,0x01,0x00,0x80,0x02,0x03,0x02,0x80,0x04,0x05,0x04,0x80,0x06,0x07,0x06,0x80
mask_pshufb_H: db 0x08,0x09,0x08,0x80,0x0A,0x0B,0x0A,0x80,0x0C,0x0D,0x0C,0x80,0x0E,0x0F,0x0E,0x80
...
ReforzarBrillo_asm:
    ...
    ; umbral y brillo, luego lo replico a lo largo de 128 bits
    ...
    ; umbral: paso de int32 a uint16 saturado, porque luego comparo a word
    ...
    ; umbral: paso de int16 a uint8 saturado, porque luego sumo/resto a byte
